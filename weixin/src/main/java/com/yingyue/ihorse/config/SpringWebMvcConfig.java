package com.yingyue.ihorse.config;
...
public class SpringWebMvcConfig extends WebMvcConfigurerAdapter {
	...
	public void addViewControllers(ViewControllerRegistry registry) {
		registry.addViewController("/validatePhone").setViewName("validate_phone");
		registry.addViewController("/agreement").setViewName("rights_and_interests");
